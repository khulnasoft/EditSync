...
def get_release_info(tag: str):
    url = f"https://api.github.com/repos/khulnasoft/editsync/releases/tags/{tag}"
...
if __name__ == "__main__":
    ...
    release_info_str += f"    </description>\n"
    release_info_str += f"    <url>https://github.com/khulnasoft/editsync/releases/tag/{tag}</url>\n"
    release_info_str += "</release>\n"

    channel_releases_file = f"../../crates/editsync/resources/flatpak/release-info/{channel}"
