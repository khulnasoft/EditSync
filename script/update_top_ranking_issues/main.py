...
def main(
    ...
    repo_name: str = "khulnasoft/editsync"
...
def get_issue_text(
    ...
    issue_text_lines.extend(
        [
            "*For details on how this issue is generated, [see the script](https://github.com/khulnasoft/editsync/blob/main/script/update_top_ranking_issues/main.py)*",
        ]
    )
