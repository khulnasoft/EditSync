...
Editsync currently maintains two public releases for macOS:

- [Stable](https://editsync.khulnasoft.com/download): This is the primary version that people download and use.
- [Preview](https://editsync.khulnasoft.com/releases/preview): which receives updates a week ahead of Stable for early adopters.
...
You will need write access to the Editsync repository to do this:

- Checkout `main` and ensure your working copy is clean.
- Run `./script/bump-editsync-minor-versions` and push the tags
  and branches as instructed.
- Wait for the builds to appear on [the Releases tab on GitHub](https://github.com/khulnasoft/editsync/releases) (typically takes around 30 minutes)
...
- After the commits are cherry-picked onto the branch, run `./script/trigger-release {preview|stable}`. This will bump the version numbers, create a new release tag, and kick off a release build.
  - This can also be run from the [GitHub Actions UI](https://github.com/khulnasoft/editsync/actions/workflows/bump_patch_version.yml):
    ![](https://github.com/khulnasoft/editsync/assets/1486634/9e31ae95-09e1-4c7f-9591-944f4f5b63ea)
- Wait for the builds to appear on [the Releases tab on GitHub](https://github.com/khulnasoft/editsync/releases) (typically takes around 30 minutes)
