...
3. Search for the contact you want to add using their GitHub handle. Note: the person you are trying to add as a contact must be an existing Editsync user.

### Inviting a collaborator

You can add an existing Editsync user as a contact from the contacts menu, deployed from the `Show contacts menu` button in the upper right-hand corner of the window or by `collab: toggle contacts menu` (`cmd-shift-c`) and then clicking the `Search for new contact` button to the right of the search box.

![Inviting a collaborator to the current project](https://editsync.khulnasoft.com/img/collaboration/add-a-collaborator.png)
...
![Receiving an invite to join a call](https://editsync.khulnasoft.com/img/collaboration/receiving-an-invite.jpg)

### Inviting non-Editsync users

If someone you want to collaborate with has not yet signed up for Editsync, they will need to [download the app](https://editsync.khulnasoft.com/download) and sign in for the first time before you can add them. Identity is tied to GitHub accounts, so new users will need to authenticate with GitHub in order to sign into Editsync.

### Voice chat

When joining a call, Editsync will automatically share your microphone with other users in the call, if your OS allows it. This isn't tied to your project. You can disable this for your client via the [`mute_on_join`](./configuring-editsync.md#calls) setting.

## Collaborating on a project

### Share a project

When you invite a collaborator to join your project, a new call begins. Your Editsync windows will show the call participants in the title bar of the window.

![A new Editsync call with two collaborators](https://editsync.khulnasoft.com/img/collaboration/new-call.png)
...
![Automatically following the person inviting us to a project](https://editsync.khulnasoft.com/img/collaboration/joining-a-call.png)
...
Collaborators will see your screen if they are following you and you start viewing a window outside Editsync or a project that is not shared.
