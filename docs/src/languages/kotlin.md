...
Kotlin language support in Editsync is provided by the community-maintained [Kotlin extension](https://github.com/editsync-extensions/kotlin).
Report issues to: [https://github.com/editsync-extensions/kotlin/issues](https://github.com/editsync-extensions/kotlin/issues)
