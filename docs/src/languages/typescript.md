...
TypeScript and TSX support are available natively in Editsync.
...
By default Editsync uses [vtsls](https://github.com/yioneko/vtsls) for TypeScript, TSX and JavaScript files.
...
Editsync sets the following initialization options to make the language server send back inlay hints
(that is, when Editsync has inlay hints enabled in the settings).

You can override these settings in your Editsync settings file.
...
- [Editsync Yarn documentation](./yarn.md) for a walkthrough of configuring your project to use Yarn.
- [Editsync Deno documentation](./deno.md)
