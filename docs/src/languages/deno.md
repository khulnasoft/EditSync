...
Deno support is available through the [Deno extension](https://github.com/khulnasoft/editsync/tree/main/extensions/deno).
...
See [Configuring supported languages](../configuring-languages.md) in the Editsync documentation for more information.
