use editsync_extension_api::{
    self as editsync, SlashCommand, SlashCommandArgumentCompletion, SlashCommandOutput,
    SlashCommandOutputSection, Worktree,
};

struct SlashCommandsExampleExtension;

impl editsync::Extension for SlashCommandsExampleExtension {
    fn new() -> Self {
    ...
    fn complete_slash_command_argument(
        ...
        _args: Vec<String>,
    ) -> Result<Vec<editsync_extension_api::SlashCommandArgumentCompletion>, String> {
...
editsync::register_extension!(SlashCommandsExampleExtension);
