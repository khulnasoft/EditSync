...
impl Intelephense {
    ...
    pub fn label_for_completion(&self, completion: editsync::lsp::Completion) -> Option<CodeLabel> {
        let label = &completion.label;

        match completion.kind? {
            editsync::lsp::CompletionKind::Method => {
            ...
            editsync::lsp::CompletionKind::Constant | editsync::lsp::CompletionKind::EnumMember => {
                if let Some(ref detail) = completion.detail {
                    if !detail.is_empty() {
                        return Some(CodeLabel {
                            spans: vec![
            ...
            editsync::lsp::CompletionKind::Property => {
            ...
            editsync::lsp::CompletionKind::Variable => {
