...
pub const DOCS_URL: &str = "https://editsync.khulnasoft.com/docs/";
                        ...
                        v_flex()
                            ...
                            .child(
                                h_flex()
                                    .w_full()
                                    .justify_center()
                                    .child(Headline::new("Welcome to Editsync")),
                            )
                            .child(
                                            ...
                                            .on_click(cx.listener(|this, _, cx| {
                                                ...
                                                this.workspace
                                                    .update(cx, |_workspace, cx| {
                                                        cx.dispatch_action(editsync_actions::theme_selector::Toggle::default().boxed_clone());
                                                    })
                                                    .ok();
                                            })),
                                    )
