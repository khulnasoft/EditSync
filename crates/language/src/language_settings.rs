...
pub struct LanguageSettings {
    ...
    /// Editsync's Prettier integration settings.
...
impl LanguageSettings {
    ...
    /// Returns the customieditsync list of language servers from the list of
    /// available language servers.
    pub fn customieditsync_language_servers(
        &self,
...
pub struct LanguageSettingsContent {
    ...
    /// when you type (, Editsync will automatically add a closing ) at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type (, Editsync will automatically surround text with ().
    ///
    /// Default: true
...
pub enum SelectedFormatter {
    /// Format files using Editsync's Prettier integration (if applicable),
...
pub enum Formatter {
    ...
    /// Format code using Editsync's Prettier integration.
    Prettier,
