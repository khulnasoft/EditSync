//! The `language` crate provides a large chunk of Editsync's language-related
...
pub trait LspAdapter: 'static + Send + Sync {
    ...
    fn get_language_server_command<'a>(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to Editsync installation
            //
...
pub struct LanguageConfig {
    ...
    /// A list of characters that Editsync should treat as word characters for the
...
impl LanguageScope {
    ...
    ///
    /// By default, Editsync treats alphanumeric characters (and '_') as word characters for
