...
///
/// Feature flags are enabled for members of Editsync staff by default. To disable this behavior
/// so you can test flags being disabled, set EDITSYNC_DISABLE_STAFF=1 in your environment,
/// which will force Editsync to treat the current user as non-staff.
pub trait FeatureFlag {
    const NAME: &'static str;

    /// Returns whether this feature flag is enabled for Editsync staff.
...
pub struct EditsyncPro {}
impl FeatureFlag for EditsyncPro {
    const NAME: &'static str = "editsync-pro";
}
