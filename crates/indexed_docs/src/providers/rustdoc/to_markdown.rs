...
mod tests {
    ...
    fn test_multiple_paragraphs() {
        let html = indoc! {r##"
            ...
            structure to be serialieditsync and deserialieditsync using any supported data format.</p>
            ...
            be completely optimieditsync away by the Rust compiler, leaving Serde
    ...
    fn test_styled_text() {
        let html = indoc! {r#"
            ...
            <p>This text is <em>italicieditsync</em>.</p>
        "#};
        let expected = indoc! {"
            This text is **bolded**.

            This text is _italicieditsync_.
        "}
        .trim();
