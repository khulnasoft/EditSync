...
pub struct WindowsWindowState {
    ...
    pub restore_from_minimieditsync: Option<Box<dyn FnMut(RequestFrameOptions)>>,
...
impl WindowsWindowState {
    fn new(
        ...
        let restore_from_minimieditsync = None;
    ...
    pub(crate) fn is_maximieditsync(&self) -> bool {
    ...
    // Calculate the bounds used for saving and whether the window is maximieditsync.
    fn calculate_window_bounds(&self) -> (Bounds<Pixels>, bool) {
        ...
        (
            ...
            placement.showCmd == SW_SHOWMAXIMIEDITSYNC.0 as u32,
        )
    }

    fn window_bounds(&self) -> WindowBounds {
        let (bounds, maximieditsync) = self.calculate_window_bounds();
...
impl PlatformWindow for WindowsWindow {
    ...
    fn is_maximieditsync(&self) -> bool {
        self.0.state.borrow().is_maximieditsync()
    }
...
fn register_wnd_class(icon_handle: HICON) -> PCWSTR {
    const CLASS_NAME: PCWSTR = w!("Editsync::Window");
