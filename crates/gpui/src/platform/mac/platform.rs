...
impl MacPlatform {
    pub(crate) fn new(headless: bool) -> Self {
        ...
        Self(Mutex::new(MacPlatformState {
            ...
            text_hash_pasteboard_type: unsafe { ns_string("editsync-text-hash") },
            metadata_pasteboard_type: unsafe { ns_string("editsync-metadata") },
            reopen: None,
            quit: None,
            menu_command: None,
        ...
        unsafe {
            ...
            let block = ConcreteBlock::new(move |error: id| {
                let result = if error == nil {
                    ...
                    let msg: id = msg_send![error, localieditsyncDescription];
                        ...
                        if response == NSModalResponse::NSModalResponseOk {
                            ...
                            if url.isFileURL() == YES {
                                result = ns_url_to_path(panel.URL()).ok().map(|mut result| {
                                    ...
                                    // https://github.com/khulnasoft/editsync/issues/16969
