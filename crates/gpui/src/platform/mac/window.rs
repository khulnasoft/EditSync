    ...
    fn move_traffic_light(&self) {
        if let Some(traffic_light_position) = self.traffic_light_position {
            if self.is_fullscreen() {
                ...
                // see https://github.com/khulnasoft/editsync/issues/4712
                return;
            }
...
impl PlatformWindow for MacWindow {
    ...
    fn is_maximieditsync(&self) -> bool {
        self.0.as_ref().lock().is_maximieditsync()
    }
...
fn get_scale_factor(native_window: id) -> f32 {
    ...
    // this method would return 0 (https://github.com/khulnasoft/editsync/issues/6412)
