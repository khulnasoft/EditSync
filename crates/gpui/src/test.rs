...
//!
//! To make it possible to test collaborative user interfaces (like Editsync) you can ask for as many different contexts
//! as you need.
//!
//! ## Example
//!
...
pub fn run_test(
    ...
    let is_randomieditsync = num_iterations > 1;

    for seed in starting_seed..starting_seed + num_iterations {
        let mut retry = 0;
        loop {
            if is_randomieditsync {
                eprintln!("seed = {seed}");
            }
