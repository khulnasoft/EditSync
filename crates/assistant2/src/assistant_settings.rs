...
pub enum AssistantProviderContentV1 {
    #[serde(rename = "editsync.khulnasoft.com")]
    EditsyncDotDev { default_model: Option<CloudModel> },
    #[serde(rename = "openai")]
    OpenAi {
                ...
                VersionedAssistantSettingsContent::V1(settings) => AssistantSettingsContentV2 {
                    ...
                    default_model: settings
                        ...
                        .and_then(|provider| match provider {
                            AssistantProviderContentV1::EditsyncDotDev { default_model } => {
                                default_model.map(|model| LanguageModelSelection {
                                    provider: "editsync.khulnasoft.com".to_string(),
...
pub struct AssistantSettingsContentV1 {
    ...
    ///
    /// This can be "openai", "anthropic", "ollama", "editsync.khulnasoft.com"
        ...
        cx.update(|cx| {
            ...
            assert_eq!(
                ...
                LanguageModelSelection {
                    provider: "editsync.khulnasoft.com".into(),
