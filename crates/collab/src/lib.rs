...
pub struct Config {
    ...
    pub editsync_environment: Arc<str>,
    ...
    pub editsync_client_checksum_seed: Option<String>,
...
impl Config {
    pub fn is_development(&self) -> bool {
        self.editsync_environment == "development".into()
    }

    /// Returns the base `editsync.khulnasoft.com` URL.
    pub fn editsync_dot_dev_url(&self) -> &str {
        match self.editsync_environment.as_ref() {
            "development" => "http://localhost:3000",
            "staging" => "https://staging.editsync.khulnasoft.com",
            _ => "https://editsync.khulnasoft.com",
        }
    }
    ...
    pub fn test() -> Self {
        Self {
            ...
            rust_log: None,
            log_json: None,
            editsync_environment: "test".into(),
            blob_store_url: None,
            ...
            editsync_client_checksum_seed: None,
