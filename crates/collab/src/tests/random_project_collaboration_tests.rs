use super::{RandomieditsyncTest, TestClient, TestError, TestServer, UserTestPlan};
use crate::{db::UserId, tests::run_randomieditsync_test};
...
#[gpui::test(
    iterations = 100,
    on_failure = "crate::tests::save_randomieditsync_test_plan"
)]
async fn test_random_project_collaboration(
    ...
    run_randomieditsync_test::<ProjectCollaborationTest>(cx, executor, rng).await;
}
...
#[async_trait(?Send)]
impl RandomieditsyncTest for ProjectCollaborationTest {
