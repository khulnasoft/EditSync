...
impl livekit::dispatcher::HttpClient for HttpClientAdapter {
    ...
    fn send_async(
        ...
        if !request.extensions().is_empty() {
            debug_panic!(
                "Livekit sent an HTTP request with a protocol extension that Editsync doesn't support!"
            );
        }
...
mod macos {
    ...
    /// Implementation from: https://github.com/khulnasoft-lab/cpal/blob/fd8bc2fd39f1f5fdee5a0690656caff9a26d9d50/src/host/coreaudio/macos/property_listener.rs#L15
