...
impl Render for KeyContextView {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl ui::IntoElement {
        ...
        v_flex()
            ...
            .child(Label::new("This view lets you determine the current context stack for creating custom key bindings in Editsync. When a keyboard shortcut is triggered, it also shows all the possible contexts it could have triggered in, and which one matched."))
            .child(
                h_flex()
                    .mt_4()
                    .gap_4()
                    .child(
                        Button::new("default", "Open Documentation")
                            ...
                            .on_click(|_, cx| cx.open_url("https://editsync.khulnasoft.com/docs/key-bindings")),
                    )
                    .child(
                        Button::new("default", "View default keymap")
                            ...
                            .on_click(|_, cx| {
                                ...
                                cx.dispatch_action(editsync_actions::OpenDefaultKeymap.boxed_clone());
                            }),
                    )
                    .child(
                        Button::new("default", "Edit your keymap")
                            .style(ButtonStyle::Filled)
                            .key_binding(ui::KeyBinding::for_action(&editsync_actions::OpenKeymap, cx))
                            .on_click(|_, cx| {
                                cx.dispatch_action(workspace::SplitRight.boxed_clone());
