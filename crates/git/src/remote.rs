...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/editsync.git",
                "https",
                "github.com",
                "/octocat/editsync.git",
            ),
            (
                "git@github.com:octocat/editsync.git",
                "ssh",
                "github.com",
                "/octocat/editsync.git",
            ),
            (
                "org-000000@github.com:octocat/editsync.git",
                "ssh",
                "github.com",
                "/octocat/editsync.git",
            ),
            (
                "ssh://git@github.com/octocat/editsync.git",
                "ssh",
                "github.com",
                "/octocat/editsync.git",
            ),
            (
                "file:///path/to/local/editsync",
                "file",
                "",
                "/path/to/local/editsync",
            ),
        ];
