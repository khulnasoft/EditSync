use crate::fallback_themes::editsync_default_dark;
...
/// Note: This setting is still experimental. See [this tracking issue](https://github.com/khulnasoft/editsync/issues/18078)
...
pub struct ThemeSettingsContent {
    ...
    /// The name of the Editsync theme to use.
    #[serde(default)]
    ...
    fn load(sources: SettingsSources<Self::FileContent>, cx: &mut AppContext) -> Result<Self> {
        ...
        let mut this = Self {
            ...
            active_theme: themes
                ...
                .or(themes.get(&editsync_default_dark().name))
                .unwrap(),
