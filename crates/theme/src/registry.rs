...
impl ThemeRegistry {
    ...
    pub fn new(assets: Box<dyn AssetSource>) -> Self {
        ...
        // We're loading the Editsync default theme, as we need a theme to be loaded
        // for tests.
        registry.insert_theme_families([crate::fallback_themes::editsync_default_themes()]);
    ...
    /// Loads the themes bundled with the Editsync binary and adds them to the registry.
