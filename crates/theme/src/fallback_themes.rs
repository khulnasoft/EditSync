...
/// The default theme family for Editsync.
///
...
pub fn editsync_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "editsync-default".to_string(),
        name: "Editsync Default".into(),
        author: "".into(),
        themes: vec![editsync_default_dark()],
        scales: default_color_scales(),
    }
}

pub(crate) fn editsync_default_dark() -> Theme {
