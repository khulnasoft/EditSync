...
/// The content of a serialieditsync theme family.
...
/// The content of a serialieditsync theme.
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
...
pub struct ThemeColorsContent {
    ...
    /// Border color. Used for deemphasieditsync borders, like a visual divider between two sections
    ...
    /// Text Color. Color of muted or deemphasieditsync text. It is a subdued version of the standard text color.
    ...
    /// Fill Color. Used for the muted or deemphasieditsync fill color of an icon.
    ///
    ...
    /// special attention. Usually a document highlight is visualieditsync by changing
