...
impl LspAdapter for ExtensionLspAdapter {
    ...
    fn get_language_server_command<'a>(
        ...
        async move {
            ...
            // TODO: This should now be done via the `editsync::make_file_executable` function in
            // Editsync extension API, but we're leaving these existing usages in place temporarily
            // to avoid any compatibility issues between Editsync and the extension versions.
            //
