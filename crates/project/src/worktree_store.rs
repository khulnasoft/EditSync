...
use text::ReplicaId;
use util::{paths::SanitieditsyncPath, ResultExt};
...
pub struct WorktreeStore {
    ...
    loading_worktrees:
        HashMap<SanitieditsyncPath, Shared<Task<Result<Model<Worktree>, Arc<anyhow::Error>>>>>,
...
impl WorktreeStore {
    ...
    pub fn find_worktree(
        &self,
        abs_path: impl Into<SanitieditsyncPath>,
        cx: &AppContext,
    ) -> Option<(Model<Worktree>, PathBuf)> {
        let abs_path: SanitieditsyncPath = abs_path.into();
    ...
    fn create_ssh_worktree(
        ...
        let mut abs_path = Into::<SanitieditsyncPath>::into(abs_path).to_string();
        ...
        cx.spawn(|this, mut cx| async move {
            ...
            let root_name = PathBuf::from(&response.canonicalieditsync_path)
                .file_name()
                .map(|n| n.to_string_lossy().to_string())
                .unwrap_or(response.canonicalieditsync_path.to_string());
            ...
            let worktree = cx.update(|cx| {
                Worktree::remote(
                    ...
                    proto::WorktreeMetadata {
                        ...
                        root_name,
                        visible,
                        abs_path: response.canonicalieditsync_path,
                    },
                    client,
                    cx,
                )
    ...
    fn create_local_worktree(
        ...
        let path: SanitieditsyncPath = abs_path.into();
