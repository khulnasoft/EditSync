...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the Editsync CLI.
...
async fn load_shell_environment(
    ...
    let fake_env = [("EDITSYNC_FAKE_TEST_ENV".into(), "true".into())]
        .into_iter()
        .collect();
    (Some(fake_env), None)
}
...
async fn load_shell_environment(
    ...
    let marker = "EDITSYNC_SHELL_START";
