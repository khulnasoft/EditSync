...
impl AssistantPanel {
        ...
        cx.spawn(|this, mut cx| async move {
            while let Some(status) = status_rx.next().await {
                this.update(&mut cx, |this, cx| {
                    ...
                    {
                        this.update_editsync_ai_notice_visibility(status, cx);
                    }
    ...
    fn update_editsync_ai_notice_visibility(
        &mut self,
    ...
    fn completion_provider_changed(&mut self, cx: &mut ViewContext<Self>) {
        ...
        if let Some(status) = self.client_status {
            self.update_editsync_ai_notice_visibility(status, cx);
        }
    }
...
impl Panel for AssistantPanel {
    ...
    fn icon(&self, cx: &WindowContext) -> Option<IconName> {
        ...
        Some(IconName::EditsyncAssistant)
    }
...
impl ContextEditor {
    ...
    fn render_payment_required_error(&self, cx: &mut ViewContext<Self>) -> AnyElement {
        const ERROR_MESSAGE: &str = "Free tier exceeded. Subscribe and add payment to continue using Editsync LLMs. You'll be billed at cost for tokens used.";
    ...
    fn render_max_monthly_spend_reached_error(&self, cx: &mut ViewContext<Self>) -> AnyElement {
        const ERROR_MESSAGE: &str = "You have reached your maximum monthly spend. Increase your spend limit to continue using Editsync LLMs.";
