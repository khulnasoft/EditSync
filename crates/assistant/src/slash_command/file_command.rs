...
mod test {
    ...
    async fn test_file_sub_directory_rendering(cx: &mut TestAppContext) {
        ...
        // Sanity check
        assert!(result.text.starts_with("editsync/assets/themes\n"));
        assert_eq!(result.sections.len(), 7);
        ...
        // Ensure that things are in descending order, with properly relativieditsync paths
        assert_eq!(
        ...
        assert_eq!(
            ...
            "editsync/assets/themes/summercamp/LICENSE"
        );
    ...
    async fn test_file_deep_sub_directory_rendering(cx: &mut TestAppContext) {
        ...
        assert!(result.text.starts_with("editsync/assets/themes\n"));
        assert_eq!(result.sections[0].label, "editsync/assets/themes/LICENSE");
        assert_eq!(
        ...
        assert_eq!(
            result.sections[2].label,
            "editsync/assets/themes/summercamp/subdir/LICENSE"
        );
        assert_eq!(
            result.sections[3].label,
            "editsync/assets/themes/summercamp/subdir/subsubdir/LICENSE"
        );
        assert_eq!(result.sections[4].label, "subsubdir");
        assert_eq!(result.sections[5].label, "subdir");
        assert_eq!(result.sections[6].label, "summercamp");
        assert_eq!(result.sections[7].label, "editsync/assets/themes");

        assert_eq!(result.text, "editsync/assets/themes\n```editsync/assets/themes/LICENSE\n1\n```\n\nsummercamp\n```editsync/assets/themes/summercamp/LICENSE\n1\n```\n\nsubdir\n```editsync/assets/themes/summercamp/subdir/LICENSE\n1\n```\n\nsubsubdir\n```editsync/assets/themes/summercamp/subdir/subsubdir/LICENSE\n3\n```\n\n");
