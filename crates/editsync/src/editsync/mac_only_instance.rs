...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Editsync Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Editsync Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Editsync Editor Preview Instance Running",
        ReleaseChannel::Stable => "Editsync Editor Stable Instance Running",
    }
}
