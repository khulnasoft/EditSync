...
pub enum RestoreOnStartupBehavior {
    ...
    LastWorkspace,
    /// Restore all workspaces that were open when quitting Editsync.
    #[default]
    LastSession,
}
...
pub struct WorkspaceSettingsContent {
    ...
    /// Controls previous session restoration in freshly launched Editsync instance.
    ...
    /// When set to false, Editsync will use the built-in keyboard-first pickers.
    ///
    /// Default: true
