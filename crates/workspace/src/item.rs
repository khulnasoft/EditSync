...
pub trait SerializableItemHandle: ItemHandle {
    fn serialieditsync_item_kind(&self) -> &'static str;
    fn serialize(
        &self,
        workspace: &mut Workspace,
        closing: bool,
...
pub mod test {
    ...
    impl TestItem {
        ...
        pub fn new_deserialieditsync(id: WorkspaceId, cx: &mut ViewContext<Self>) -> Self {
    ...
    impl SerializableItem for TestItem {
        ...
        fn deserialize(
            ...
            let view = cx.new_view(|cx| Self::new_deserialieditsync(workspace_id, cx));
            Task::ready(Ok(view))
        }
