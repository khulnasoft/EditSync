//! See [Telemetry in Editsync](https://editsync.khulnasoft.com/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system Editsync is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each Editsync installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in Editsync user (randomly generated on first sign in)
    /// Identifier unique to each Editsync session (differs for each time you open Editsync)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for Editsync staff, otherwise false
    pub is_staff: Option<bool>,
    /// Editsync version number
    pub app_version: String,
    pub os_name: String,
    pub os_version: Option<String>,
    pub architecture: String,
    /// Editsync release channel (stable, preview, dev)
