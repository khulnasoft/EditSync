...
const PYTHON_ACTIVE_TOOLCHAIN_PATH: VariableName =
    VariableName::Custom(Cow::Borrowed("PYTHON_ACTIVE_EDITSYNC_TOOLCHAIN"));
        ...
        tasks.extend(match test_runner {
            TestRunner::UNITTEST => {
                [
                    ...
                    TaskTemplate {
                        label: "unittest $EDITSYNC_CUSTOM_PYTHON_TEST_TARGET".to_owned(),
                        command: PYTHON_ACTIVE_TOOLCHAIN_PATH.template_value(),
                        args: vec![
                            "-m".to_owned(),
                            "unittest".to_owned(),
            ...
            TestRunner::PYTEST => {
                [
                    ...
                    // Run test(s) for a specific target within a file
                    TaskTemplate {
                        label: "pytest $EDITSYNC_CUSTOM_PYTHON_TEST_TARGET".to_owned(),
                        command: PYTHON_ACTIVE_TOOLCHAIN_PATH.template_value(),
                        args: vec![
                            "-m".to_owned(),
                            "pytest".to_owned(),
