...
pub(super) fn typescript_task_context() -> ContextProviderWithTasks {
    ContextProviderWithTasks::new(TaskTemplates(vec![
        ...
        TaskTemplate {
            label: "jest test $EDITSYNC_SYMBOL".to_owned(),
            command: "npx jest".to_owned(),
            args: vec![
        ...
        TaskTemplate {
            label: "execute selection $EDITSYNC_SELECTED_TEXT".to_owned(),
...
impl LspAdapter for EsLintLspAdapter {
    ...
    async fn workspace_configuration(
        ...
        let mut code_action_on_save = json!({
            ...
            // in the Editsync configuration, it doesn't have an effect.
            "enable": true,
        });
