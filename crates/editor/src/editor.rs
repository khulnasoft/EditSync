...
//! The main point of interest in this crate is [`Editor`] type, which is used in every other Editsync part as a user input element.
...
/// Editsync's primary text input `View`, allowing users to edit a [`MultiBuffer`]
///
...
impl Editor {
    ...
    pub fn new_file(
        ...
        Self::new_in_workspace(workspace, cx).detach_and_prompt_err(
            ...
            |e, _| match e.error_code() {
                ...
                "The remote instance of Editsync does not support this yet. It must be upgraded to {}",
    ...
    fn trigger_on_type_formatting(
        ...
        // OnTypeFormatting returns a list of edits, no need to pass them between Editsync instances,
...
pub fn hunks_for_ranges(
    ...
    for query_range in ranges {
        ...
        for hunk in snapshot.diff_map.diff_hunks_in_range(
            ...
            // Deleted hunk is an empty row range, no caret can be placed there and Editsync allows to revert it
