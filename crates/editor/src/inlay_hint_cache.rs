...
pub(super) enum InvalidationStrategy {
    ...
    ///
    /// A special case is the settings change: in addition to LSP capabilities, Editsync allows omitting certain hint kinds (defined by the corresponding LSP part: type/parameter/other).
