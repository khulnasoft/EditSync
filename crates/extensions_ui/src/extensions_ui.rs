...
actions!(editsync, [InstallDevExtension]);

pub fn init(cx: &mut AppContext) {
    cx.observe_new_views(move |workspace: &mut Workspace, cx| {
        workspace
            .register_action(move |workspace, _: &editsync_actions::Extensions, cx| {
        ...
        if !themes.is_empty() {
            workspace
                .update(cx, |_workspace, cx| {
                    cx.dispatch_action(
                        editsync_actions::theme_selector::Toggle {
                            ...
                            .when(!is_compatible, |upgrade_button| {
                                upgrade_button.disabled(true).tooltip({
                                    ...
                                    move |cx| {
                                        Tooltip::text(
                                            format!(
                                                "v{version} is not compatible with this version of Editsync.",
                                            ),
                                            cx,
                                        )
                                    }
        ...
        v_flex().children(self.upsells.iter().enumerate().map(|(ix, feature)| {
            let upsell = match feature {
                Feature::Git => FeatureUpsell::new(
                    "Editsync comes with basic Git support. More Git features are coming in the future.",
                )
                .docs_url("https://editsync.khulnasoft.com/docs/git"),
                Feature::OpenIn => FeatureUpsell::new(
                    "Editsync supports linking to a source line on GitHub and others.",
                )
                .docs_url("https://editsync.khulnasoft.com/docs/git#git-integrations"),
                Feature::Vim => FeatureUpsell::new("Vim support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/vim")
                ...
                Feature::LanguageBash => FeatureUpsell::new("Shell support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/bash"),
                Feature::LanguageC => FeatureUpsell::new("C support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/c"),
                Feature::LanguageCpp => FeatureUpsell::new("C++ support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/cpp"),
                Feature::LanguageGo => FeatureUpsell::new("Go support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/go"),
                Feature::LanguagePython => FeatureUpsell::new("Python support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/python"),
                Feature::LanguageReact => FeatureUpsell::new("React support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/typescript"),
                Feature::LanguageRust => FeatureUpsell::new("Rust support is built-in to Editsync!")
                    .docs_url("https://editsync.khulnasoft.com/docs/languages/rust"),
                Feature::LanguageTypescript => {
                    FeatureUpsell::new("Typescript support is built-in to Editsync!")
                        .docs_url("https://editsync.khulnasoft.com/docs/languages/typescript")
                }
            };
