...
/// Fetches Editsync-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, returns whether the Editsync-relevant info has changed
