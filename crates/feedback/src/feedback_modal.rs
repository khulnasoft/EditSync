...
impl FeedbackModal {
    ...
    async fn submit_feedback(
        ...
        let telemetry = editsync_client.telemetry();
        let installation_id = telemetry.installation_id();
        let metrics_id = telemetry.metrics_id();
        let is_staff = telemetry.is_staff();
        let http_client = editsync_client.http_client();
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .gap_1()
                    .child(
                        Button::new("editsync_repository", "Editsync Repository")
                            .style(ButtonStyle::Transparent)
                            .icon(IconName::ExternalLink)
                            .icon_position(IconPosition::End)
                            .icon_size(IconSize::Small)
                            .on_click(open_editsync_repo),
                    )
                    .child(
                        h_flex()
                            .gap_1()
                            ...
                            .child(
                                Button::new("submit_feedback", submit_button_text)
                                    ...
                                    .tooltip(move |cx| {
                                        Tooltip::text("Submit feedback to the Editsync team.", cx)
                                    })
