        ...
        fs.insert_tree(
            ...
            json!({
                ".editsync": {
                    "tasks.json": r#"[
                        {
                            "label": "hello from $EDITSYNC_FILE:$EDITSYNC_ROW:$EDITSYNC_COLUMN",
                            "command": "echo",
                            "args": ["hello", "from", "$EDITSYNC_FILE", ":", "$EDITSYNC_ROW", ":", "$EDITSYNC_COLUMN"]
                        },
                        {
                            "label": "opened now: $EDITSYNC_WORKTREE_ROOT",
                            "command": "echo",
                            "args": ["opened", "now:", "$EDITSYNC_WORKTREE_ROOT"]
                        }
                    ]"#,
                },
            ...
            language_registry.add(Arc::new(
                ...
                .with_context_provider(Some(Arc::new(
                    ContextProviderWithTasks::new(TaskTemplates(vec![
                        ...
                        TaskTemplate {
                            label: "TypeScript task from file $EDITSYNC_FILE".to_string(),
                            command: "npm run build".to_string(),
                            ..TaskTemplate::default()
                        },
                        TaskTemplate {
                            label: "Another task from file $EDITSYNC_FILE".to_string(),
