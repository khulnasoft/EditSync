//! A source of tasks, based on a static configuration, deserialieditsync from the tasks config file, and related infrastructure for tracking changes to the file.
