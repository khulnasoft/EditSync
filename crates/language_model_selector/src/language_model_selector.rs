...
const TRY_EDITSYNC_PRO_URL: &str = "https://editsync.khulnasoft.com/pro";
...
impl PickerDelegate for LanguageModelPickerDelegate {
    ...
    fn render_match(
        ...
        let show_badges = cx.has_flag::<EditsyncPro>();
                        ...
                        .child(
                            h_flex()
                                ...
                                .children(match model_info.availability {
                                    ...
                                    LanguageModelAvailability::RequiresPlan(Plan::EditsyncPro) => {
                                        show_badges.then(|| {
                                            Label::new("Pro")
                                                .size(LabelSize::XSmall)
                                                .color(Color::Muted)
    ...
    fn render_footer(&self, cx: &mut ViewContext<Picker<Self>>) -> Option<gpui::AnyElement> {
        ...
        let plan = proto::Plan::EditsyncPro;
        let is_trial = false;
        ...
        Some(
            h_flex()
                ...
                .gap_4()
                .justify_between()
                .when(cx.has_flag::<EditsyncPro>(), |this| {
                    this.child(match plan {
                        // Already a Editsync Pro subscriber
                        Plan::EditsyncPro => Button::new("editsync-pro", "Editsync Pro")
                            .icon(IconName::EditsyncAssistant)
                            .icon_size(IconSize::Small)
                            .icon_color(Color::Muted)
                            .icon_position(IconPosition::Start)
                            .on_click(|_, cx| {
                                cx.dispatch_action(Box::new(editsync_actions::OpenAccountSettings))
                            }),
                        // Free user
                        ...
                        .on_click(|_, cx| cx.open_url(TRY_EDITSYNC_PRO_URL)),
                    })
                })
                .child(
