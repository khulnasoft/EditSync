...
impl Render for ReplSessionsPage {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        // When there are no kernel specifications, show a link to the Editsync docs explaining how to
                ...
                .child(
                    h_flex().w_full().p_4().justify_center().gap_2().child(
                        ButtonLike::new("install-kernels")
                            ...
                            .on_click(move |_, cx| {
                                cx.open_url(
                                    "https://editsync.khulnasoft.com/docs/repl#language-specific-instructions",
                                )
                            }),
                    ),
                );
