...
impl Render for ConfigurationView {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        const INSTRUCTIONS: [&str; 3] = [
            "To use Editsync's assistant with Google AI, you need to add an API key. Follow these steps:",
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(
                    Label::new(
                        format!("You can also assign the {GOOGLE_AI_API_KEY_VAR} environment variable and restart Editsync."),
                    )
