...
impl Render for ConfigurationView {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        const INSTRUCTIONS: [&str; 4] = [
            "To use Editsync's assistant with OpenAI, you need to add an API key. Follow these steps:",
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(
                    Label::new(
                        format!("You can also assign the {OPENAI_API_KEY_VAR} environment variable and restart Editsync."),
                    )
