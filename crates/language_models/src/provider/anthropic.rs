...
pub struct AnthropicSettings {
    pub api_url: String,
    /// Extend Editsync's list of Anthropic models.
...
pub struct AvailableModel {
    ...
    pub name: String,
    /// The model's name in Editsync's UI, such as in the model selector dropdown menu in the assistant panel.
...
impl Render for ConfigurationView {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        const INSTRUCTIONS: [&str; 3] = [
            "To use Editsync's assistant with Anthropic, you need to add an API key. Follow these steps:",
            "- Create one at:",
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(
                    Label::new(
                        format!("You can also assign the {ANTHROPIC_API_KEY_VAR} environment variable and restart Editsync."),
                    )
