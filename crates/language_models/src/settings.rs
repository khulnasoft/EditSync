...
use crate::provider::{
    ...
    cloud::{self, EditsyncDotDevSettings},
...
pub struct AllLanguageModelSettings {
    ...
    pub editsync_dot_dev: EditsyncDotDevSettings,
...
pub struct AllLanguageModelSettingsContent {
    ...
    pub editsync_dot_dev: Option<EditsyncDotDevSettingsContent>,
...
#[derive(Default, Clone, Debug, Serialize, Deserialize, PartialEq, JsonSchema)]
pub struct EditsyncDotDevSettingsContent {
...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn load(sources: SettingsSources<Self::FileContent>, _: &mut AppContext) -> Result<Self> {
        ...
        for value in sources.defaults_and_customizations() {
            ...
            merge(
                &mut settings.editsync_dot_dev.available_models,
                value
                    .editsync_dot_dev
                    .as_ref()
