...
fn view_release_notes_locally(workspace: &mut Workspace, cx: &mut ViewContext<Workspace>) {
    ...
    let url = match release_channel {
        ReleaseChannel::Nightly => Some("https://github.com/khulnasoft/editsync/commits/nightly/"),
        ReleaseChannel::Dev => Some("https://github.com/khulnasoft/editsync/commits/main/"),
        _ => None,
    };
