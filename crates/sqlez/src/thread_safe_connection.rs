...
impl<M: Migrator> ThreadSafeConnection<M> {
    ...
    /// Opens a new db connection with the initialieditsync file path. This is internal and only
...
mod test {
    ...
    fn wild_editsync_lost_failure() {
        ...
        let builder =
            ThreadSafeConnection::<TestWorkspace>::builder("wild_editsync_lost_failure", false)
