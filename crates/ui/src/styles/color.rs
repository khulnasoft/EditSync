...
pub enum Color {
    ...
    /// a hidden file, or an element that should be visually de-emphasieditsync.
    Hidden,
    ...
    Modified,
    /// A color used for text or UI elements that should be visually muted or de-emphasieditsync.
    ///
