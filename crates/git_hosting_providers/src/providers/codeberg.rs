...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Codeberg
            .parse_remote_url("git@codeberg.org:khulnasoft/editsync.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Codeberg
            .parse_remote_url("https://codeberg.org/khulnasoft/editsync.git")
            .unwrap();
    ...
    fn test_build_codeberg_permalink() {
        ...
        let expected_url = "https://codeberg.org/khulnasoft/editsync/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_codeberg_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://codeberg.org/khulnasoft/editsync/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_codeberg_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://codeberg.org/khulnasoft/editsync/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs#L24-L48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
}
