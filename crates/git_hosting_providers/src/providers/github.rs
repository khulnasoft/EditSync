...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Github
            .parse_remote_url("git@github.com:khulnasoft/editsync.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Github
            .parse_remote_url("https://github.com/khulnasoft/editsync.git")
            .unwrap();
    ...
    fn test_build_github_permalink_from_ssh_url() {
        ...
        let expected_url = "https://github.com/khulnasoft/editsync/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_github_permalink() {
        ...
        let expected_url = "https://github.com/khulnasoft/editsync/blob/b2efec9824c45fcc90c9a7eb107a50d1772a60aa/crates/editsync/src/main.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_github_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://github.com/khulnasoft/editsync/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_github_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://github.com/khulnasoft/editsync/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L24-L48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_github_pull_requests() {
        ...
        assert_eq!(
            Github
                ...
                .url
                .as_str(),
            "https://github.com/khulnasoft/editsync/pull/10687"
        );
