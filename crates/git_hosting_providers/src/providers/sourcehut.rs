...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Sourcehut
            .parse_remote_url("git@git.sr.ht:~khulnasoft/editsync")
            .unwrap();
    ...
    fn test_parse_remote_url_given_ssh_url_with_git_suffix() {
        let parsed_remote = Sourcehut
            .parse_remote_url("git@git.sr.ht:~khulnasoft/editsync.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Sourcehut
            .parse_remote_url("https://git.sr.ht/~khulnasoft/editsync")
            .unwrap();
    ...
    fn test_build_sourcehut_permalink() {
        ...
        let expected_url = "https://git.sr.ht/~khulnasoft/editsync/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_sourcehut_permalink_with_git_suffix() {
        ...
        let expected_url = "https://git.sr.ht/~khulnasoft/editsync.git/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://git.sr.ht/~khulnasoft/editsync/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://git.sr.ht/~khulnasoft/editsync/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
}
