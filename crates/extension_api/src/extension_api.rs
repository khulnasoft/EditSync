//! The Editsync Rust Extension API allows you write extensions for [Editsync](https://editsync.khulnasoft.com/) in Rust.
...
pub use wit::{
    ...
    editsync::extension::nodejs::{
        node_binary_path, npm_install_package, npm_package_installed_version,
        npm_package_latest_version,
    },
    editsync::extension::platform::{current_platform, Architecture, Os},
...
pub mod lsp {
    pub use crate::wit::editsync::extension::lsp::{
        Completion, CompletionKind, InsertTextFormat, Symbol, SymbolKind,
    };
}

/// A result returned from a Editsync extension.
...
/// Registers the provided type as a Editsync extension.
///
...
macro_rules! register_extension {
    ($extension_type:ty) => {
        ...
        pub extern "C" fn __init_extension() {
            ...
            editsync_extension_api::register_extension(|| {
                Box::new(<$extension_type as editsync_extension_api::Extension>::new())
            });
        }
    };
}
