...
pub use latest::{
    editsync::extension::lsp::{
        Completion, CompletionKind, CompletionLabelDetails, InsertTextFormat, Symbol, SymbolKind,
    },
    editsync::extension::slash_command::{SlashCommandArgumentCompletion, SlashCommandOutput},
...
pub fn authorize_access_to_unreleased_wasm_api_version(
    ...
    if !allow_unreleased_version {
        Err(anyhow!(
            "unreleased versions of the extension API can only be used on development builds of Editsync"
        ))?;
    }
