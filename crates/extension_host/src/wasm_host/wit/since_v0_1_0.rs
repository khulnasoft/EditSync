...
wasmtime::component::bindgen!({
    ...
    with: {
         ...
         "editsync:extension/http-client/http-response-stream": ExtensionHttpResponseStream,
         "editsync:extension/github": latest::editsync::extension::github,
         "editsync:extension/nodejs": latest::editsync::extension::nodejs,
         "editsync:extension/platform": latest::editsync::extension::platform,
         "editsync:extension/slash-command": latest::editsync::extension::slash_command,
    },
});

pub use self::editsync::extension::*;
