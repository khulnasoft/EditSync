...
impl ExtensionImports for WasmState {
    ...
    async fn latest_github_release(
        ...
        latest::editsync::extension::github::Host::latest_github_release(self, repo, options).await
    }

    async fn current_platform(&mut self) -> Result<(Os, Architecture)> {
        latest::editsync::extension::platform::Host::current_platform(self).await
    }
