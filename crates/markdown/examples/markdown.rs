...
## Links
Links are created using the format [http://editsync.khulnasoft.com](https://editsync.khulnasoft.com).

They can also be detected automatically, for example https://editsync.khulnasoft.com/blog.
            ...
            cx.new_view(|cx| {
                let markdown_style = MarkdownStyle {
                    base_text_style: gpui::TextStyle {
                        font_family: "Editsync Plex Sans".into(),
                        color: cx.theme().colors().terminal_ansi_black,
                        ..Default::default()
                    },
                    code_block: StyleRefinement::default()
                        .font_family("Editsync Plex Mono")
                        .m(rems(1.))
                        .bg(rgb(0xAAAAAAA)),
                    inline_code: gpui::TextStyleRefinement {
                        font_family: Some("Editsync Mono".into()),
